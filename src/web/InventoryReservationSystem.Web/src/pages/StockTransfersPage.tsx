...
export default function StockTransfersPage() {
  ...
  function submit(e: FormEvent) {
    ...
    transferM.mutate({ sku, sourceWarehouseId, targetWarehouseId, quantity, reason: reason || 'Warehouse rebalance' });
  }
      ...
      <Card title="Transfer stock between warehouses">
        ...
        <form className="form-grid" onSubmit={submit}>
          ...
          <button type="submit" className="btn btn--primary" disabled={transferM.isPending}>
            {transferM.isPending ? 'Transferring…' : 'Transfer stock'}
          </button>
        </form>
        ...
        {transferM.data && (
          <div className="result-panel">
            ...
            {transferM.data.errorMessage
              ? <span>{transferM.data.errorCode}: {transferM.data.errorMessage}</span>
