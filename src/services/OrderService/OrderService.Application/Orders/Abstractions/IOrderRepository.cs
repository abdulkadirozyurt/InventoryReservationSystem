...
public interface IOrderRepository
{
    ...
    Task<IReadOnlyList<Order>> ListDetailedAsync(DateTime from, DateTime to, string? sku, string? warehouseId, OrderStatus? status, CancellationToken cancellationToken = default);
